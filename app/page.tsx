  ...
  "@graph": [
    {
      ...
      "@id": `${SITE_URL}/#website`,
      url: SITE_URL,
      name: "Cabbage HSK Writing",
      alternateName: ["Cabbage HSK", "白菜 HSK 写作", "배추 HSK 쓰기", "HSK六级写作练习", "HSK 6 쓰기 연습"],
      inLanguage: ["en", "zh-CN", "ko-KR"],
      image: `${SITE_URL}/cabbage-mascot.png`,
    },
    {
      "@type": "WebApplication",
      ...
      inLanguage: ["en", "zh-CN", "ko-KR"],
      image: `${SITE_URL}/write-hsk-product-preview.png`,
      brand: {
        "@type": "Brand",
        name: "Cabbage HSK Writing",
        logo: `${SITE_URL}/cabbage-mascot.png`,
      },
      offers: {
        "@type": "Offer",
        price: "0",
