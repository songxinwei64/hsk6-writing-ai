...
export default function AiFeedbackPanel({ practiceItemId, answerTitle, answerText, isPaidMember }: Props) {
  ...
  async function requestFeedback() {
    ...
    try {
      ...
      const result = await response.json() as { feedback?: AiWritingFeedback; remaining?: number; error?: string };
  ...
  return (
    <section className="ai-feedback-panel">
      ...
      {!isPaidMember && <p className="ai-feedback-access">AI反馈目前仅对会员开放。</p>}
      ...
      {feedback && (
        <div className="ai-feedback-content">
          ...
          {remaining !== null && <small>今天还可以获取 {remaining} 次AI反馈</small>}
        </div>
      )}
